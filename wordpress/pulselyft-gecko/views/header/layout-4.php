 ...
 */
?>
<header id="jas-header" class="header-4" <?php jas_gecko_schema_metadata( array( 'context' => 'header' ) ); ?>>
	<div class="header__top bgbl pl__30 pr__30">
		<div class="jas-row middle-xs">
			<div class="jas-col-md-4 jas-col-sm-6 jas-col-xs-12 flex start-md start-sm center-xs">
				<?php if ( cs_get_option( 'header-top-left' ) ) : ?>
					<div class="header-text mr__15"><?php echo do_shortcode( cs_get_option( 'header-top-left' ) ); ?></div>
				<?php endif; ?>
				...
				<a href="javascript:void(0);" class="jas-push-menu-btn">
					<?php
						if ( cs_get_option( 'mobile-icon' ) ) :
							...
							echo '<img src="' . esc_url( $icon[0] ) . '" width="25" height="22" alt="Menu" />';
						else :
							echo '<img src="' . JAS_GECKO_URL . '/assets/images/icons/hamburger-black.svg" width="25" height="22" alt="Menu" />';
						endif;
					?>
				</a>
			</div>
