...
?>
<div class="jas-blog-slider jas-carousel" data-slick='{"slidesToShow": <?php echo esc_attr( $item ); ?>,"slidesToScroll": 1, "responsive":[{"breakpoint": 960,"settings":{"slidesToShow": 2}},{"breakpoint": 480,"settings":{"slidesToShow": 1}}]<?php echo ( is_rtl() ? ',"rtl":true' : '' ); ?>}'>
				...
				<?php
					if ( has_post_thumbnail() ) :
						...
						if ( $img[1] >= 480 && $img[2] >= 310 ) {
							$image = jas_resizer( $img[0], 470, 310, true );
