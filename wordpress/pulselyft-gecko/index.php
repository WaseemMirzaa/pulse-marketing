...
// Get blog layout
$layout = apply_filters( 'jas_gecko_blog_layout', cs_get_option( 'blog-layout' ) );
...
// Blog style
$class = $data = $sizer = '';
$style = apply_filters( 'jas_gecko_blog_style', cs_get_option( 'blog-style' ) );
if ( $style == 'masonry' ) {
	$class = ' jas-masonry';
	$data  = 'data-masonry=\'{"selector":".post", "columnWidth":".grid-sizer", "layoutMode":"masonry"' . ( is_rtl() ? ',"rtl": false' : ',"rtl": true' ) . '}\'';
