...
$quickview = true;
?>
<?php do_action( 'woocommerce_quickview_before' ); ?>
<div <?php post_class("product-quickview pr"); ?> id="product-<?php the_ID(); ?>">
	<div class="jas-row">
		<div class="jas-col-md-7 jas-col-sm-7 jas-col-xs-12">
...
<?php do_action( 'woocommerce_quickview_after' ); ?>