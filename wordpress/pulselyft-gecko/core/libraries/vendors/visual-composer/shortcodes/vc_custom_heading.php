 ...
 */
$source = $text = $sub_title = $link = $google_fonts = $font_container = $el_id = $el_class = $css = $css_animation = $font_container_data = $google_fonts_data = '';
...
if ( apply_filters( 'vc_custom_heading_template_use_wrapper', false ) ) {
	...
	$output .= $text;
	if ( $sub_title ) {
		$output .= '<span class="sub-title db">' . $sub_title . '</span>';
	}
