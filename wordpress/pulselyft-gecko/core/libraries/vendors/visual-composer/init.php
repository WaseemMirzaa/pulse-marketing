...
// disabled for Visual Composer automatic update
vc_is_updater_disabled();

// Change default template directory.
vc_set_shortcodes_templates_dir( JAS_GECKO_PATH . '/core/libraries/vendors/visual-composer/shortcodes' );

// Include custom functions of vc element
$maps = 'row, column, heading, service, portfolio, member, blog, product, products, wc-categories, instagram, vertical-slide, promotion, meta-slider, slider';
