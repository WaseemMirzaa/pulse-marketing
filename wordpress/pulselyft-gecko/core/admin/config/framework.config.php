...
$options[] = array(
	...
	'fields' => array(
		array(
			...
			'desc'    => esc_html__( 'Set the maximum allowed width for content, include unit. Example for: px or %', 'gecko' ),
			'default' => '1170px'
		),
		array(
			'id'    => 'boxed',
...
$options[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'type'    => 'switcher',
			'title'   => esc_html__( 'Enable live search', 'gecko' ),
			'default' => false
		),
		array(
			'type'    => 'subheading',
		...
		array(
			'id'        => 'mobile-icon',
			'type'      => 'image',
			'title'     => esc_html__( 'Menu icon', 'gecko' ),
			'add_title' => esc_html__( 'Upload', 'gecko' )
		),
		array(
			'type'    => 'subheading',
		...
		array(
			'type'    => 'subheading',
			'content' => esc_html__( 'Header main settings', 'gecko' ),
		),
		array(
			'id'      => 'header-search-icon',
			'type'    => 'switcher',
			'title'   => esc_html__( 'Enable search icon', 'gecko' ),
			'default' => true,
		),
		array(
			'id'      => 'header-my-account-icon',
			'type'    => 'switcher',
			'title'   => esc_html__( 'Enable my account icon', 'gecko' ),
			'default' => true,
		)
	),
);
...
$options[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'default' => sprintf( wp_kses_post( 'Copyright 2019 <span class="cp">Gecko</span> all rights reserved. Powered by <a href="%s">JanStudio</a>', 'gecko' ), esc_url( home_url() ) )
		),
	),
);
	...
	$options[]  = array(
		...
		'sections' => array(
			...
			array(
				...
				'fields' => array(
					...
					array(
						'id'    => 'wc-badge-type',
						'type'  => 'select',
						'title' => esc_html__( 'Sale Badge Type', 'gecko' ),
						'desc'  => esc_html__( 'Apply for product simple only', 'gecko' ),
						'options' => array(
							'text'    => esc_html__( 'Text', 'gecko' ),
							'percent' => esc_html__( 'Discount percent', 'gecko' ),
						),
						'default' => 'text'
					)
				)
			...
			array(
				...
				'fields' => array(
					...
					array(
						'id'         => 'wc-atc-behavior',
						'type'       => 'select',
						'title'      => esc_html__( 'Add to cart behavior', 'gecko' ),
						'options' => array(
							'slide' => esc_html__( 'Slide sidebar', 'gecko' ),
							'popup' => esc_html__( 'Popup included upsell products', 'gecko' ),
						),
						'default' => 'slide'
					),
					array(
						'id'      => 'wc-sticky-atc',
						'type'    => 'switcher',
						'title'   => esc_html__( 'Enable Sticky Add to cart', 'gecko' ),
						'default' => false,
					),
					array(
						'id'      => 'wc-single-zoom',
					...
					array(
						...
						'id'    => 'wc-extra-content',
						'type'  => 'textarea',
						'desc'  => esc_html__( 'This text will be displayed right below add to cart button, HTML allowed.', 'gecko' )
					),
					array(
			...
			array(
				...
				'title'  => esc_html__( 'Cart & Checkout Settings', 'gecko' ),
				'icon'   => 'fa fa-minus',
				'fields' => array(
					array(
						'type'    => 'heading',
						'content' => esc_html__( 'Mini cart Setting', 'gecko' ),
					),
					array(
						'id'    => 'wc-minicart-content',
						'title' => esc_html__( 'MiniCart Content', 'gecko' ),
						'type'  => 'textarea',
						'desc'  => esc_html__( 'This text will be displayed right below checkout button, HTML allowed.', 'gecko' )
					),
					array(
						'type'    => 'heading',
						'content' => esc_html__( 'Cart Setting', 'gecko' ),
					),
					array(
						'id'    => 'wc-cart-content',
						'title' => esc_html__( 'Cart Content', 'gecko' ),
						'type'  => 'textarea',
						'desc'  => esc_html__( 'This text will be displayed right below cart total, HTML allowed.', 'gecko' )
					),
					array(
						'type'    => 'heading',
						'content' => esc_html__( 'Checkout Setting', 'gecko' ),
					),
					array(
						'id'    => 'wc-checkout-content',
						'title' => esc_html__( 'Checkout Content', 'gecko' ),
						'type'  => 'textarea',
						'desc'  => esc_html__( 'This text will be displayed right below checkout button, HTML allowed.', 'gecko' )
					),
				)
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'type'    => 'select',
					'title'   => esc_html__( 'Content display on blog list', 'gecko' ),
					'options' => array(
						'content' => esc_html__( 'Content', 'gecko' ),
						'excerpt' => esc_html__( 'Excerpt', 'gecko' ),
					),
				),
			),
		),
...
$options[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'type'  => 'color_picker',
			'title' => esc_html__( 'Header Icons Color', 'gecko' ),
			'default' => '#000',
		),
		array(
			'id'      => 'main-menu-color',
		...
		array(
			'type'    => 'subheading',
			'content' => esc_html__( 'Header Transparent Color', 'gecko' ),
		),
		array(
		...
		array(
			'type'    => 'subheading',
			'content' => esc_html__( 'Header Sticky Color', 'gecko' ),
		),
		array(
			'id'      => 'header-sticky-background',
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Header Sticky Background', 'gecko' ),
			'default' => '#fff'
		),
		array(
			'id'      => 'sticky-main-menu-color',
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Header Sticky Main Menu Color', 'gecko' ),
			'default' => '#4d5959'
		),
		array(
			'id'      => 'sticky-main-menu-hover-color',
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Header Sticky Main Menu Hover Color', 'gecko' ),
			'default' => '#b59677'
		),
		array(
			'id'      => 'sticky-sub-menu-background-color',
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Header Sticky Sub Menu Background Color', 'gecko' ),
			'default' => '#3e3e3e'
		),
		array(
			'id'      => 'sticky-sub-menu-color',
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Header Sticky Sub Menu Color', 'gecko' ),
			'default' => '#fff'
		),
		array(
			'id'      => 'sticky-sub-menu-color-hover',
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Header Sticky Sub Menu Hover Color', 'gecko' ),
			'default' => '#b59677'
		),
		array(
			'id'    => 'header-sticky-icons-color',
			'type'  => 'color_picker',
			'title' => esc_html__( 'header-sticky-icons-color', 'gecko' ),
			'default' => '#000',
		),
		array(
			'type'    => 'subheading',
		...
		array(
			...
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Footer Link Color', 'gecko' ),
			'default' => '#fff'
		),
		array(
			'id'      => 'footer-color-hover',
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Footer Link Hover Color', 'gecko' ),
			'default' => '#b59677'
		),
		array(
			'id'      => 'footer-color',
		...
		array(
			...
			'type'    => 'color_picker',
			'title'   => esc_html__( 'Footer Bottom Background Color', 'gecko' ),
			'default' => '#000'
		),
	),
);
...
$options[] = array(
	...
	'fields' => array(
		...
		array(
			'type'	  => 'subheading',
			'content' => esc_html__('Enable Social Share', 'gecko'),
		),
		array(
			'id'      => 'wc-social-share',
			'type'    => 'switcher',
			'title'   => esc_html__( 'Enable Social Share', 'gecko' ),
			'default' => true,
		),
		array(
			'id'         => 'facebook-share',
			'type'       => 'switcher',
			'title'      => esc_html__( 'Enable Facebook Share', 'gecko' ),
			'default'    => true,
		...
		array(
			'id'      	 => 'twitter-share',
			'type'    	 => 'switcher',
			'title'      => esc_html__( 'Enable Twitter Share', 'gecko' ),
			'default'    => true,
			'dependency' => array( 'wc-social-share', '==', 'true' ),
		),
		array(
			'id'       	 => 'pinterest-share',
			'type'    	 => 'switcher',
			'title'    	 => esc_html__( 'Enable Pinterest Share', 'gecko' ),
			'default' 	 => true,
			'dependency' => array( 'wc-social-share', '==', 'true' ),
		),
		array(
			'id'         => 'tumblr-share',
			'type'       => 'switcher',
			'title'      => esc_html__( 'Enable Tumblr Share', 'gecko' ),
			'default'  	 => true,
			'dependency' => array( 'wc-social-share', '==', 'true' ),
		),
		array(
			'id'         => 'vk-share',
			'type'       => 'switcher',
			'title'      => esc_html__( 'Enable VK Share', 'gecko' ),
			'default'  	 => false,
			'dependency' => array( 'wc-social-share', '==', 'true' ),
		),
		array(
			'id'         => 'linkedin-share',
			'type'       => 'switcher',
			'title'      => esc_html__( 'Enable LinkedIn Share', 'gecko' ),
			'default'  	 => false,
			'dependency' => array( 'wc-social-share', '==', 'true' ),
		),
		array(
			'id'         => 'whatsapp-share',
			'type'       => 'switcher',
			'title'      => esc_html__( 'Enable WhatsApp Share', 'gecko' ),
			'default'  	 => false,
			'dependency' => array( 'wc-social-share', '==', 'true' ),
		),
		array(
			'id'         => 'telegram-share',
			'type'       => 'switcher',
			'title'      => esc_html__( 'Enable Telegram Share', 'gecko' ),
			'default'  	 => false,
			'dependency' => array( 'wc-social-share', '==', 'true' ),
		),
	),
